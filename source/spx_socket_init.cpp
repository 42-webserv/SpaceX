...
// 	uint32_t listen_sd = socket(AF_INET, SOCK_STREAM, 0);
// 	if (listen_sd < 0) {
...
// 	if (setsockopt(listen_sd, SOL_SOCKET, SO_REUSEPORT, &opt, sizeof(opt)) == -1) { // NOTE:: SO_REUSEPORT
...
// 		// 	}
// 		// }
// 		temp_port_info.listen_sd				   = listen_sd;
...
// 	if (listen(listen_sd, LISTEN_BACKLOG_SIZE) < 0) {
// 		error_exit("listen", close, listen_sd);
// 	}
// 	config_info.clear();
// 	return spx_ok;
// }
